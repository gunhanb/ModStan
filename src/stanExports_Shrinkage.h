...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(97, 95, "end", "model_Shrinkage");
    return reader;
}
#include <stan_meta_header.hpp>
class model_Shrinkage : public prob_grad {
private:
        int N_obs;
        int N_schedule;
        int N_pred;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "prior_stdev_beta", "double", context__.to_vec());
            prior_stdev_beta = double(0);
            vals_r__ = context__.vals_r("prior_stdev_beta");
            pos__ = 0;
            prior_stdev_beta = vals_r__[pos__++];
            check_greater_or_equal(function__, "prior_stdev_beta", prior_stdev_beta, 0);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        try {
            writer__.scalar_unconstrain(theta_2_raw);
        } catch (const std::exception& e) {
        ...
        current_statement_begin__ = 32;
        if (!(context__.contains_r("mu_theta_2_raw")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable mu_theta_2_raw missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("mu_theta_2_raw");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "mu_theta_2_raw", "double", context__.to_vec());
        double mu_theta_2_raw(0);
        mu_theta_2_raw = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, mu_theta_2_raw);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable mu_theta_2_raw: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 33;
        if (!(context__.contains_r("beta_theta_2")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable beta_theta_2 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("beta_theta_2");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "beta_theta_2", "double", context__.to_vec());
        double beta_theta_2(0);
        beta_theta_2 = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, beta_theta_2);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable beta_theta_2: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                theta_2_raw = in__.scalar_constrain(lp__);
            else
                theta_2_raw = in__.scalar_constrain();
            current_statement_begin__ = 31;
            ...
            current_statement_begin__ = 32;
            local_scalar_t__ mu_theta_2_raw;
            (void) mu_theta_2_raw;  // dummy to suppress unused var warning
            if (jacobian__)
                mu_theta_2_raw = in__.scalar_lb_constrain(0, lp__);
            else
                mu_theta_2_raw = in__.scalar_lb_constrain(0);
            current_statement_begin__ = 33;
            local_scalar_t__ beta_theta_2;
            (void) beta_theta_2;  // dummy to suppress unused var warning
            if (jacobian__)
                beta_theta_2 = in__.scalar_lb_constrain(0, lp__);
            else
                beta_theta_2 = in__.scalar_lb_constrain(0);
            // transformed parameters
            current_statement_begin__ = 37;
            local_scalar_t__ log_mu_theta_2;
            (void) log_mu_theta_2;  // dummy to suppress unused var warning
            stan::math::initialize(log_mu_theta_2, DUMMY_VAR__);
            stan::math::fill(log_mu_theta_2, DUMMY_VAR__);
            ...
            validate_non_negative_index("log_theta_2", "N_schedule", N_schedule);
            std::vector<local_scalar_t__> log_theta_2(N_schedule, local_scalar_t__(0));
            stan::math::initialize(log_theta_2, DUMMY_VAR__);
            stan::math::fill(log_theta_2, DUMMY_VAR__);
            ...
            stan::math::assign(log_mu_theta_2, stan::math::log((mu_theta_2_raw * maxdose)));
            current_statement_begin__ = 45;
            stan::model::assign(log_theta_2, 
                        stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list()), 
                        log_mu_theta_2, 
                        "assigning variable log_theta_2");
            current_statement_begin__ = 47;
            stan::model::assign(log_theta_2, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                        (log_mu_theta_2 + (theta_2_raw * beta_theta_2)), 
                        "assigning variable log_theta_2");
            ...
            stan::model::assign(theta_2, 
                        stan::model::cons_list(stan::model::index_uni(2), stan::model::nil_index_list()), 
                        stan::math::exp(get_base1(log_theta_2, 1, "log_theta_2", 1)), 
                        "assigning variable theta_2");
            current_statement_begin__ = 52;
            stan::model::assign(theta_2, 
                        stan::model::cons_list(stan::model::index_uni(1), stan::model::nil_index_list()), 
                        (stan::math::exp(get_base1(log_theta_2, 2, "log_theta_2", 1)) / 2), 
                        "assigning variable theta_2");
            ...
            (void) function__;  // dummy to suppress unused var warning
            current_statement_begin__ = 37;
            if (stan::math::is_uninitialized(log_mu_theta_2)) {
                std::stringstream msg__;
                msg__ << "Undefined transformed parameter: log_mu_theta_2";
                stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable log_mu_theta_2: ") + msg__.str()), current_statement_begin__, prog_reader__());
            }
            current_statement_begin__ = 38;
            ...
            current_statement_begin__ = 39;
            size_t log_theta_2_k_0_max__ = N_schedule;
            for (size_t k_0__ = 0; k_0__ < log_theta_2_k_0_max__; ++k_0__) {
                if (stan::math::is_uninitialized(log_theta_2[k_0__])) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: log_theta_2" << "[" << k_0__ << "]";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable log_theta_2: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 40;
            ...
            lp_accum__.add(normal_log<propto__>(theta_2_raw, 0, 1));
            ...
            lp_accum__.add(lognormal_log<propto__>(mu_theta_2_raw, -(2.5), 1.8));
            current_statement_begin__ = 74;
            lp_accum__.add(normal_log<propto__>(beta_theta_2, 0, prior_stdev_beta));
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("mu_theta_2_raw");
        names__.push_back("beta_theta_2");
        names__.push_back("log_mu_theta_2");
        names__.push_back("resp_hat");
        names__.push_back("log_theta_2");
    ...
    void write_array(RNG& base_rng__,
        ...
        double theta_2_raw = in__.scalar_constrain();
        vars__.push_back(theta_2_raw);
        double sigma = in__.scalar_lb_constrain(0);
        vars__.push_back(sigma);
        double mu_theta_2_raw = in__.scalar_lb_constrain(0);
        vars__.push_back(mu_theta_2_raw);
        double beta_theta_2 = in__.scalar_lb_constrain(0);
        vars__.push_back(beta_theta_2);
        double lp__ = 0.0;
        ...
        try {
            ...
            current_statement_begin__ = 39;
            validate_non_negative_index("log_theta_2", "N_schedule", N_schedule);
            std::vector<double> log_theta_2(N_schedule, double(0));
            stan::math::initialize(log_theta_2, DUMMY_VAR__);
            stan::math::fill(log_theta_2, DUMMY_VAR__);
            current_statement_begin__ = 40;
            validate_non_negative_index("theta_2", "N_schedule", N_schedule);
            ...
            if (include_tparams__) {
                vars__.push_back(log_mu_theta_2);
                size_t resp_hat_j_1_max__ = N_obs;
                for (size_t j_1__ = 0; j_1__ < resp_hat_j_1_max__; ++j_1__) {
                ...
                size_t log_theta_2_k_0_max__ = N_schedule;
                for (size_t k_0__ = 0; k_0__ < log_theta_2_k_0_max__; ++k_0__) {
                    vars__.push_back(log_theta_2[k_0__]);
                }
                size_t theta_2_k_0_max__ = N_schedule;
                for (size_t k_0__ = 0; k_0__ < theta_2_k_0_max__; ++k_0__) {
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "mu_theta_2_raw";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "beta_theta_2";
        param_names__.push_back(param_name_stream__.str());
        if (!include_gqs__ && !include_tparams__) return;
        if (include_tparams__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "log_mu_theta_2";
            param_names__.push_back(param_name_stream__.str());
            size_t resp_hat_j_1_max__ = N_obs;
            for (size_t j_1__ = 0; j_1__ < resp_hat_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
            ...
            for (size_t k_0__ = 0; k_0__ < log_theta_2_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "log_theta_2" << '.' << k_0__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t theta_2_k_0_max__ = N_schedule;
            for (size_t k_0__ = 0; k_0__ < theta_2_k_0_max__; ++k_0__) {
